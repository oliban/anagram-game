...
const DatabasePlayer = require('../../server/models/DatabasePlayer');
const DatabasePhrase = require('../../server/models/DatabasePhrase');
const { HintSystem } = require('../../server/services/hintSystem');
const { detectLanguage } = require('../../server/services/difficultyScorer');
